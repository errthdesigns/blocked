...
export default function Desktop7() {
  return (
    <div className="bg-[magenta] relative size-full" data-name="Desktop - 7">
      ...
      <div className="absolute flex h-[182.935px] items-center justify-center left-[759px] top-[626.31px] w-[416.558px]">
        <div className="flex-none rotate-[348.058deg]">
          <div className="bg-center bg-cover bg-no-repeat h-[101.483px] rounded-[15px] w-[404.324px]" data-name="Group 3 1" style={{ backgroundImage: `url('${imgGroup31}')` }} />
        </div>
      </div>
